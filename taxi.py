...
# ML Prediction Page
    ...
    # Display the scatterplot of residuals over predicted values in Streamlit
    st.subheader('Scatterplot of Residuals over Predicted Values')

    # Create a scatterplot of residuals over predicted values
    fig, ax = plt.subplots(figsize=(8, 6))
    sns.scatterplot(x='predicted', y='residual', data=results, ax=ax)
    plt.axhline(0, c='red')
...
# You can continue adding more pages and corresponding navigation buttons as needed